...
import { infosReceitas } from '../services/infosReceitas';
import Popup from "../../../components/layout/CustomPopUp"
import { useNavigate } from 'react-router-dom';
import { ReceitaForm } from '../components/ReceitaForm'
import { ReceitaFormData } from '../types/receita';

const initialFormData = infosReceitas
...
export function ReceitasCadastro() {
  
  const [formData, setFormData] = useState<ReceitaFormData>(initialFormData);
  ...
  const infosValores: (keyof ReceitaFormData)[] = ['custoReposicao', 'valorVenda']
  ...
  return (
    <div className='flex w-full h-auto min-h-screen'>
      ...
      <div className="bg-slate-50 p-4 flex-1">
        ...
        <div className="h-auto rounded-lg shadow-md p-4 ">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-foreground mb-2">Cadastro de Receitas</h1>
...
export default ReceitasCadastro;